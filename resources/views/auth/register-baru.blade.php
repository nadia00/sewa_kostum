...
<html>
    ...
    <body>
            <div class="head">
                <div class="logo">
                    <a href=" {{ url('/login-baru') }} "><h4 style="margin-left: 5%; color: #ffffff;">Sudah punya akun?</h4></a>
                    ...
                    <div class="sap_tabs">
                        <div id="horizontalTab" style="display: block; width: 100%; margin: 0px;">
                            <ul class="resp-tabs-list">
                                <li class="resp-tab-item" aria-controls="tab_item-0" role="tab"><span>Penyewa</span></li>
                                <li class="resp-tab-item" aria-controls="tab_item-1" role="tab"><label>/</label><span>Penyedia Jasa</span></li>
                                ...
                                <div class="tab-1 resp-tab-content" aria-labelledby="tab_item-0">
                                    <div class="login-top">
                                        ...
                                        <div class="login-bottom login-bottom1">
                                            <div class="submit">
                                                <input type="submit" value="LOGIN JASA"/>
                                            </div>
                                            <div class="clear"></div>
                                        </div>	
                                    </div>
