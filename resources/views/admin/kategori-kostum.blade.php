                            ...
                            <div class="modal-dialog">
                                ...
                                <div class="modal-content">
                                    <div class="modal-header">
                                        ...
                                        <h4 class="modal-title">Perbarui Data Kategori</h4>
                                    </div>
                                    <div class="modal-body">
                                        <form method="post" action="{{ route('admin.kategori-edit') }}" enctype="multipart/form-data">
                                            {{ csrf_field() }}
                                            <input type="hidden" class="form-control {{ $errors->has('nama') ? ' is-invalid' : '' }}" id="nama" placeholder="Masukan Nama" name="id" value="{{$val->id}}">
                                            <div class="form-group">
                                                <label for="nama">Nama</label>
                                                <input type="text" class="form-control {{ $errors->has('nama') ? ' is-invalid' : '' }}" id="nama" placeholder="Masukan Nama" name="name" value="{{$val->nama}}">
                                                @if ($errors->has('nama'))
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control {{ $errors->has('deskripsi') ? ' is-invalid' : '' }}" id="username" placeholder="Enter Username" name="username" value="{{$val->deskripsi}}">
